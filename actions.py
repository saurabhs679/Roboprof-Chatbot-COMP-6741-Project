...
class ActionListCompetencies(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if "results" in results and "bindings" in results["results"]:
            ...
            dispatcher.utter_message(text=f"No competencies found for course {course_number}.")
...
class ActionListGrades(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if "results" in results and "bindings" in results["results"]:
            ...
            dispatcher.utter_message(text=f"No grades found for {student_entity} in {course_entity}.")
...
class ActionListStudentsByCompletedCourse(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if "results" in results and "bindings" in results["results"]:
            ...
            dispatcher.utter_message(f"No students found who have completed course {completed_course}.")
...
class ActionShowDescription(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if description:
            ...
            dispatcher.utter_message(text=f"No description found for the course {course}.")
...
class ActionListTopicByCourseEvent(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        query = f"""
            ...
            WHERE {{
              ?topic ex:topic_in_course ex:{course_code} ;
        ...
        if "results" in results and "bindings" in results["results"] and results["results"]["bindings"]:
            ...
            dispatcher.utter_message(text=f"No topics found for the course {course_code}.")
...
class ActionListTopicContent(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if "results" in results and "bindings" in results["results"] and results["results"]["bindings"]:
            ...
            dispatcher.utter_message(text=f"No content found for the topic {topic}.")
